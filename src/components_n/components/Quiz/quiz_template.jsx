...
const QuizApp = () => {
    ...
    const [selectedOptions, setSelectedOptions] = useState([]); // New state variable to store selected options
    ...
    const handleSaveM = () => {
        ...
        setSelectedOptions(prevOptions => [...prevOptions, selectedOption+1]);
