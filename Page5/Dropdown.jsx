        ...
        <div className="dropdown">
            ...
            {dropdownOpen && (
                <div className="dropdown-content" id="myDropdown">
                    ...
                    <a href="#" className="dropdown-text" onClick={handleAnchorClick2}>Material</a>
                    <br />
...
function AllTopics() {
    ...
    return (
        <div>
            ...
            <a href="#" className="dropdown-text" onClick={handleAnchorClick1} >Create</a>
            <br />
            {showBox && <div className="topics-box">

            <button id="allTopicsBtn2" >
                    <div className="create-button-contents">
                        <div> <h3>+ </h3>
                        </div>
                        <div className="part-2"><h6>Start Class</h6></div>
                    </div>
                </button>

                <button id="allTopicsBtn" onClick={toggleInput} >
                    <div className="create-button-contents">
                        <div> <h3>+ </h3>
                        </div>
                        <div className="part-2"><h6>Create Courses</h6></div>
                    </div>
                </button>

                {showInput && (
                    <form className="courses-form">
                        <label className="courses-name">
                            Course Name:
                            <input type="text" />
                        </label>
                        <button type="submit" className="courses-submit">Submit</button>
                    </form>
                )}
